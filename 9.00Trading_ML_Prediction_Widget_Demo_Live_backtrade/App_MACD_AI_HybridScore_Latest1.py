...
class TradingApp:
    def __init__(self, root):
        ...
        self.root = root
        self.root.title("v10.0-Multi-Layered Trading (MACD) Hybrid Score Latest")
        self.running = False
    ...
    def _get_builtin_defaults(self):
        """
        Minimal emergency fallback used ONLY if strategies.MomentumStrategy_MACD_HybridScore_Latest
